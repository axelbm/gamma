<div>
	...
	<div class="body">
			...
			<form id="page_answer" role="form" method="post">
				...
				<div class="form-group list-group">
						<?php if(count($answers) == 1){ ?>
							<input type="hidden" name="answer" value="<?php echo $answers[1]['destination']; ?>">
		...
		<br>
		<a role="button" class="btn btn-success btn-block" href="<?php echo WEBROOT.'page/add/'.$page['id']; ?>"><span class="glyphicon glyphicon-plus-sign"></span> Ajouter un choix</a>
	</div>
</div>