...
<div class="panel panel-default">
	<div class="panel-body">
		<ul class="nav nav-tabs">
			<li><a class="active" data-toggle="tab" href="#profil">Profil</a></li>
			<li><a data-toggle="tab" href="#setting">Parametre</a></li>
			<li><a data-toggle="tab" href="#security">Sécurité</a></li>
		</ul>
